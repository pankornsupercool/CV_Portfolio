...
function HomePage() {
    return (
        <HeaderContainer>
            ...
            <Container3 as={motion.div} initial={{ opacity: 0, scale: 0.5 }}
                animate={{ opacity: 1, scale: 1 }}
            ...
            <Container4 as={motion.div} initial={{ opacity: 0, scale: 0.5 }}
                animate={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.9, delay: 0.2, ease: [0, 0.71, 0.2, 1.01] }}>
            ...
            <Container5 as={motion.div} initial={{ opacity: 0, scale: 0.5 }}
                animate={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.9, delay: 0.2, ease: [0, 0.71, 0.2, 1.01] }}>
                <h3>Currently Looking For Internship Positions 🐻‍❄️</h3>
                <h4>🍉 Front-end Developer</h4>
                <h4>🍉 UX/UI Design</h4>
                <h4>🍉 Any position. I'm ready for learning new things but it might take some times.</h4>
            </Container5>
        </HeaderContainer>
    );
}
